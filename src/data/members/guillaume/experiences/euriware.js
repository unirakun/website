  ...
  informations: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          text: "Mise en place des forges logicielles utiles au développement des différents projets",
        },
        {
        ...
        { text: "Mise en place de recettes fonctionnelles" },
      ],
    },
    {
      text: "Technologies utilisées : ",
      children: [{ text: "GWT / AngularJS" }, { text: "Java 6 / Spring" }],
    },
  ],
}
